...
internal class ObjectToken : RegistryDataKey, ISpObjectToken, ISpObjectTokenMss, ISpDataKey
{
    [ComImport]
    ...
    protected ObjectToken(string keyId, RegistryDataKey key)
        : base(keyId, key)
    {
    }
    ...
    internal static ObjectToken Open(string sCategoryId, string sTokenId, bool fCreateIfNotExist)
    {
        ...
        {
            text = sCategoryId.Trim(trimChars) + "\\Tokens\\";
        }

        text += sTokenId.Trim(trimChars);
        RegistryDataKey registryDataKey = RegistryDataKey.Open(text, fCreateIfNotExist);
        if (registryDataKey != null)
        {
            return new ObjectToken(text, registryDataKey);
        }
    ...
    internal T CreateObjectFromToken<T>(string name)
    {
        ...
        try
        {
            ...
            if ((object)val is ISpObjectWithToken spObjectWithToken)
            {
